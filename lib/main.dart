...
String username =
    "Abednego"; //We would fetch the username from the database and replace it with this
String roomID =
    'abednego'; /*
 ...
 */
String subject =
    "HDG Meting"; //This can be maintained with respect to what the Company want to use.
String email =
    "jilimajohnabednego@gmail.com"; // The email of the user if there is.  It is not really necessary to have it
